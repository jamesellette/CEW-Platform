...
// Scheduling API - for exercise scheduling and calendar management
export const schedulingApi = {
  // Schedule management
  createSchedule: (title, description, scenarioId, scenarioName, startTime, endTime, options = {}) =>
    api.post('/schedules', {
      title,
      description,
      scenario_id: scenarioId,
      ...
      auto_provision: options.autoProvision ?? true,
      auto_teardown: options.autoTeardown ?? true,
  ...
  updateSchedule: (scheduleId, updates) => api.put(`/schedules/${scheduleId}`, updates),

  cancelSchedule: (scheduleId) => api.post(`/schedules/${scheduleId}/cancel`),

  deleteSchedule: (scheduleId) => api.delete(`/schedules/${scheduleId}`),

  startSchedule: (scheduleId) => api.post(`/schedules/${scheduleId}/start`),

  completeSchedule: (scheduleId) => api.post(`/schedules/${scheduleId}/complete`),
